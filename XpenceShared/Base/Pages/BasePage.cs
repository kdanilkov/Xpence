...
namespace XpenceShared.Base.Pages
{
    public class BasePage : ContentPage
    {
		...
		public BasePage()
		{
			...
			_mainLayout.RowDefinitions.Add(new RowDefinition { Height = new GridLength(1, GridUnitType.Auto) });
        ...
        public static readonly BindableProperty IsLoadingProperty = BindableProperty.Create(nameof(IsLoading), typeof(bool), typeof(BasePage), default(bool),propertyChanged: onLoadingChanging);

        private static void onLoadingChanging(BindableObject bindable, object oldValue, object newValue)
        {
